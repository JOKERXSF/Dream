        ...
        for index, job in enumerate(job_list):
            try:
                ...
                companyTitle = job.find_element(by=By.XPATH,
                                                value=".//div[@class='job-card-right']/div[contains(@class,'company-info')]/h3/a").text
                # companyAvatar
                companyAvatar = job.find_element(by=By.XPATH,
                                                 value=".//div[@class='job-card-right']/div[contains(@class,'company-logo')]/a/img").get_attribute(
                    "src")

                companyInfos = job.find_elements(by=By.XPATH,
                                                 value=".//div[@class='job-card-right']/div[contains(@class,'company-info')]/ul[@class='company-tag-list']/li")
                ...
                companyUrl = job.find_element(by=By.XPATH,
                                              value=".//div[@class='job-card-right']/div[contains(@class,'company-info')]/h3/a").get_attribute(
                    'href')
...
if __name__ == "__main__":
    spiderObj = spider('c%2Fc%2B%2B', 1)
    # spiderObj.init()
    # spiderObj.main(10)
